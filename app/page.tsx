      ...
      <div className="relative h-screen bg-black flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <p className="text-gray-300 max-w-xl mx-auto text-base md:text-lg">
            Say goodbye to manual hiring. Our AI-driven platform automates job
            posts, filters top talent, ranks candidates, and schedules
            interviews — all from one smart dashboard.
          </p>
          <Button
            asChild
